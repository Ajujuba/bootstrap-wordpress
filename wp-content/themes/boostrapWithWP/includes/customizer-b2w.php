...
new \Kirki\Field\Text(
    [
        ...
        'label'           => esc_html__('Author', 'bootstrap2wordpress'),
        'tooltip'         => esc_html__('Name of author', 'bootstrap2wordpress'),
        'section'         => 'b2w_footer_section',
        'default'         => esc_html__('Ana', 'bootstrap2wordpress'),
        'partial_refresh' => array(
            'footer_author' => array(
            'selector'          => 'footer .copyright h6',
            'render_callback'   => function() {
                return get_theme_mod( 'footer_author' );
            }
            ),
        ),
    ]
